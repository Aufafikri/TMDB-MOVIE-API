            ...
            <div key={movie.id}>
              <Card>
                ...
                <img
                  ...
                  className="w-80 h-80 object-cover image-scale max-sm:place-content-center max-sm:place-items-center"
                  />
              </Link>
                ...
                <button className="w-full p-3 dark:bg-slate-900 mt-4 dark:hover:bg-slate-800 transition-all duration-200">See {trunCateText(movie.title, 20)} Movie</button>
                  </Card>
              </div>
            ))}
      </div>
